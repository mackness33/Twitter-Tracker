...
class TwitterService():
    ...
    def get_stream(self, headers, set, bearer_token):
        response = requests.get(
            ...
            "https://api.twitter.com/2/tweets/sample/stream?tweet.fields=created_at,entities,geo,author_id&expansions=geo.place_id,author_id,attachments.media_keys&place.fields=contained_within,country,country_code,full_name,geo,id,name,place_type&user.fields=description,created_at,name,url&media.fields=preview_image_url", headers=headers, stream=True,
        )
